function Banner() {
  return (
    <div className="flex flex-row justify-center mt-8 sm:mt-12 md:mt-16 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-[1000px] mx-auto min-h-[130px] flex flex-col lg:flex-row items-center gap-6 lg:gap-0 px-4 sm:px-6 lg:px-10">
        {/* Text Section */}
        <div className="flex flex-col w-full lg:w-2/4 gap-1 text-center lg:text-left">
