function OurServices() {
  return (
    <div className="flex flex-col w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 bg-center bg-cover bg-none dark:bg-[url('/assets/images/serviceBg.png')]">
      ...
      <div className="flex flex-row justify-start">
        <div className="flex flex-col w-full max-w-[940px] h-[460px] relative justify-end group">
