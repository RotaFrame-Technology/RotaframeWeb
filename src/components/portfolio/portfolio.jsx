function Portfolio() {
  const portfolioItems = [
    ...
    },
    {
      ...
      github: "",
      behance: "https://www.behance.net/gallery/186917209/Travel-Booking-Mobile-Application-UI",
      readMore: "",
    },
    {
      title: "iNfo",
    ...
    },
    {
      title: "Rest Provide",
      description:
        "A clean, user-friendly set of onboarding screens designed for a food ordering mobile app, guiding users through setup, preferences, and first-use flows with clarity and visual appeal.",
      icon: "/assets/images/portfoliomobileicon.png",
      ...
      width: "w-full sm:w-1/4",
      github: "",
      behance: "https://www.behance.net/gallery/189119713/Onboarding-Pages-for-Online-Food-Ordering-Platform",
      readMore: "",
    },
    {
      title: "insider Business",
                  ...
                  <div className="flex flex-col gap-2 mt-4 sm:mt-6">
                    ...
                    {item.readMore ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex flex-row items-center gap-2 mt-3 cursor-pointer"
                      >
