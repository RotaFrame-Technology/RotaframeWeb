    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 w-full max-w-[1440px] relative z-10 mt-8">
          <h1 className="text-[36px] sm:text-4xl md:text-5xl lg:text-6xl xl:text-[56px] leading-tight sm:leading-snug md:leading-[60px] lg:leading-[70px] xl:leading-[72px] font-bold mb-4 w-full sm:w-11/12 text-white dark:text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-16 items-center w-full sm:w-auto mb-12">
            ...
            <button
              ...
              className="w-[220px] sm:w-auto px-4 sm:px-6 h-[52px] border bg-gray-300  border-black text-black  dark:text-[black] text-base sm:text-lg font-semibold rounded-[16px] transition-all duration-200 hover:brightness-95 hover:text-white  dark:hover:text-black cursor-pointer"
            >
              Contact Us
            </button>
          </div>
